...
;; ## added by OPAM user-setup for emacs / tuareg ## 97631b08d913f6a23f10b7ccd52872ae ## you can edit, but keep this line
...
(defun opam-tuareg-autoload (fct file doc args)
  (let ((load-path (cons "/home/bokwoon/.opam/system/share/emacs/site-lisp" load-path)))
    (load file))
  (apply fct args))
